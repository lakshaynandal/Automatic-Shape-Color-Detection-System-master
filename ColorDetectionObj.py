...
lower = {'red': (110,160,0), 'green': (66, 122, 129), 'blue': (97, 100, 117), 'yellow': (23, 59, 119)}  # assign new item lower['blue'] = (93, 10, 0)
upper = {'red': (250,255,255), 'green': (86, 255, 255), 'blue': (117, 255, 255), 'yellow': (54, 255, 255)}
...
if not args.get("video", False):
    ...
    # camera = cv2.VideoCapture('http://25.18.130.31:8080/video')
...
while True:
    ...
    # URL = 'http://192.168.43.224:8080/photo.jpg'
